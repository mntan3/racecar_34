...
class BlobDetection:
    def __init__(self):
        self.node_name = "blob_detection_node"
    ...
    def processImage(self, image_msg):
        ...
        template_ari = cv2.imread(
        template_racecar = cv2.imread
        template_sirtash = cv2.imread
        template_cat = cv2.imread
        # print(height)
